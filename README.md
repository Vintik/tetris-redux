...
Built using [react-redux-starter-kit](https://github.com/davezuko/react-redux-starter-kit) as a base boilerplate.
...
If everything works, you should see the home page with a link to go play Tetris.
